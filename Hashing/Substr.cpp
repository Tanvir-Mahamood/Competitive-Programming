...
void solve()
{
    string str;
    //cin >> str;
    str = "abaabbaaabaabbaa";

    build(str);

    //cout << (get_hash(1,2) == get_hash(5,6)) << nn;
    // get_hash(starting idx, ending idx);
    pair<int, int> ans1 = get_hash(6,13);
    pair<int, int> ans2 = get_hash(7,14);
    pair<int, int> ans3 = get_hash(3,10);
    cout << ans1.first << " " << ans1.second << nn;
    cout << ans2.first << " " << ans2.second << nn;
    cout << ans3.first << " " << ans3.second << nn;
}
